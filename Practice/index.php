...
<section class='login' id='login'>
  ...
  <div class='form'>
    <form>
  <input type="text" placeholder='Type Username' class='text' id='username' required><br>
  <input type="password" placeholder='Type Password' class='password'><br>
  <a href="#" class='btn-login' id='do-login'>Login</a>
  <a href="#" class='forgot' id='do-forgot'> Forgot? </a>
    </form>
  </div>
</section>
<!-- partial -->
